            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="javascript:;">Edit Blog</a>
                    </div>
                                ...
                                <div class="card ">
                                    ...
                                    <div class="card-body ">
                                        <form method="post" enctype="multipart/form-data"
                                            action="{{ route('admin.updateblog', $blogs->id) }}"
                                            ...
                                            <div class="row">
                                                <input type="hidden" id="setcategory"
                                                    value="{{ old('blog_category', $blogs->blog_category) }}">
                                                    ...
                                                    <div class="form-group bmd-form-group">
                                                        <div class="dropdown bootstrap-select">
                                                            <select class="selectpicker"
                                                                ...
                                                                title="Edit Category" name="blog_category"
                                                                id="blog_category">
                                                                <option name="blog_category" value="Airseal"
                                                                    {{ $blogs->blog_category == 'Airseal' ? 'selected' : '' }}>
                                                                    Airseal </option>
                                                                <option name="blog_category" value="Aeropower"
                                                                    {{ $blogs->blog_category == 'Aeropower' ? 'selected' : '' }}>
                                                                    Aeropower </option>
                                                                <option name="blog_category"
                                                                    value="Hot Dip Galvanizing"
                                                                    {{ $blogs->blog_category == 'Hot Dip Galvanizing' ? 'selected' : '' }}>
                                                                    Hot Dip Galvanizing </option>
                                                                <option name="blog_category" value="Grating"
                                                                    {{ $blogs->blog_category == 'Grating' ? 'selected' : '' }}>
                                                                    Grating </option>
                                                            </select>
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-group bmd-form-group">
                                                        <input type="text" name="headdescription"
                                                            class="form-control" value="{{ $blogs->description1 }}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div>
                                                            <span class="btn btn-rose btn-round btn-file">
                                                                ...
                                                                <input type="file" name="image1"
                                                                    value="{{ old('/public/img/', $blogs->image1) }}">
                                                ...
                                                <div class="col-md-4 m-auto">
                                                    <div class="fileinput text-center fileinput-new"
                                                        ...
                                                        <div class="fileinput-new thumbnail">
                                                            <img src="{{ url('blogimg/', $blogs->image1) }}"
                                                                alt="...">
                                                        </div>
                                                        <div>
